...
type Settings = { agencyName:string; contactName:string; contactEmail:string; phone:string; address:string; schedule:string; updatedAt?:string };
const initial: Settings = { agencyName:"Ideamos Propiedades", contactName:"Equipo Ideamos", contactEmail:"hola@ideamos.ar", phone:"+54 11 5555 0190", address:"Av. del Libertador 2424, Buenos Aires", schedule:"Lun. a vie. / 9 a 18 h" };
...
export function SettingsManager({ signOutPath }:{ signOutPath:string }) {
  ...
  return <div className="admin-settings-stack">
    <section className="admin-content-card admin-settings-card settings-manager">
      <div className="admin-list-head"><div><p>CONFIGURACION GENERAL</p><h2>Identidad y contacto</h2><span>Actualiza los datos publicos y administra tu acceso con claridad.</span></div><ShieldCheck/></div>
