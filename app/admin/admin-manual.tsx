...
const guides: Guide[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "En Ideamos, abr\u00ed Ajustes del sitio > Tokko Broker. Peg\u00e1 la API key obtenida en Mi Empresa > Permisos, prob\u00e1 la conexi\u00f3n y guard\u00e1 la integraci\u00f3n como Activa.",
      "Presion\u00e1 Sincronizar ahora. Solo ingresan las propiedades disponibles y habilitadas para web; luego las novedades se actualizan autom\u00e1ticamente.",
