...
const guides: Guide[] = [
  ...
  },
  {
    ...
    steps: [
      "En Tokko, complet\u00e1 la ficha, el precio, los detalles y la multimedia de cada propiedad o emprendimiento.",
      ...
      "Prob\u00e1 la conexi\u00f3n, guard\u00e1 la integraci\u00f3n como Activa y presion\u00e1 Sincronizar ahora. La revisi\u00f3n incluye las propiedades y los emprendimientos habilitados para web.",
      "Solo ingresan las propiedades disponibles y los emprendimientos habilitados para web. Si Tokko devuelve 0, revis\u00e1 el interruptor Publicar de cada ficha y volv\u00e9 a probar la conexi\u00f3n.",
      "Para pausar, dej\u00e1 la integraci\u00f3n Inactiva y guard\u00e1. Para eliminar la API key, los IDs y el historial, us\u00e1 Desvincular Tokko y confirm\u00e1. Las propiedades y los emprendimientos existentes se conservan.",
    ],
    tip: "Desvincular Tokko no borra las propiedades ni los emprendimientos manuales o ya importados; simplemente detiene el v\u00ednculo y elimina las credenciales guardadas.",
